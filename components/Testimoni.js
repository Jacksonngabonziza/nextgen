...
const Testimoni = ({
  listTestimoni = [
    {
      name: "Jean Bosco",
      image: "/assets/Dank.png",
      city: "Kigali",
      country: "Rwanda",
      rating: "4.8",
      testimoni:
        "The real estate management solution has made managing my properties in Kigali so much easier. Highly recommended!",
    },
    {
      name: "Alice Umutoni",
      ...
      rating: "4.7",
      testimoni:
        "I am very happy with the property management system. It is user-friendly and has helped streamline my rental operations.",
    },
    {
      ...
      rating: "4.6",
      testimoni:
        "The software has been a game-changer for my real estate business in Rubavu. Excellent features and great support.",
    },
    {
      name: "Marie Claire",
      image: "/assets/alice.png",
      ...
      rating: "4.5",
      testimoni:
        "I am very impressed with the property management solution. It has simplified the management of my properties in Huye.",
    },
  ],
}) => {
  const settings = {
